...
// ==========================================
// NUEVO: Cálculo e impresión de la brecha cambiaria
// ==========================================
const difBs = TASAS_DEL_DIA.paralelo - TASAS_DEL_DIA.bcv;
const porcentaje = (difBs / TASAS_DEL_DIA.bcv) * 100;

// Inyectamos el porcentaje (+X.X%) y la diferencia en Bs en el HTML
...
btnCopiar.addEventListener('click', () => {
    ...
    navigator.clipboard.writeText(textoReciboEl.value).then(() => {
        ...
        // Removido LaTeX para unidades de tiempo simples
        }, 2000);
    }).catch(err => {
