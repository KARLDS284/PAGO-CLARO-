...
// =====================================================================
// 3. Función para conectarse a internet y traer las tasas en vivo
// =====================================================================
async function obtenerTasasEnVivo() {
    try {
        ...
        // Ejecuta un recálculo automático por si el usuario ya escribió antes de recibir la API
...
function actualizarCalculadora() {
    ...
    // Si el campo está vacío o es un número negativo, reiniciamos la vista
...
btnCopiar.addEventListener('click', () => {
    ...
    navigator.clipboard.writeText(textoReciboEl.value).then(() => {
        ...
        btnCopiar.style.background = "#10b981"; // Cambia temporalmente a un verde plano esmeralda
        btnCopiar.style.color = "#ffffff";
        
        setTimeout(() => {
            btnCopiar.innerHTML = textoOriginal;
            btnCopiar.style.background = ""; // Al dejarlo vacío vuelve a tomar el degradado de tu CSS
            btnCopiar.style.color = ""; // Retoma el color de texto del CSS original
        }, 2000);
    }).catch(err => {
